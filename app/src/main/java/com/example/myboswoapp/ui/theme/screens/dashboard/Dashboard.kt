package com.example.myboswoapp.ui.theme.screens.dashboard
...
import com.example.myboswoapp.data.DashboardViewModel
...
@Composable
fun StatsSection(stats: List<DashboardStart>) {
    Row(
...
@Composable
fun StatCard(stat: DashboardStart) {
    Card(
